...
require 'homebus-tick/options'
require 'homebus-tick/app'

require 'homebus/config'

class TestHomebusTick < HomebusTick::App
...
describe HomebusTick do
  context "Version number" do
    it "Has a version number" do
      expect(HomebusTick::VERSION).not_to be_nil
      expect(HomebusTick::VERSION.class).to be String
    end
  end 
end

describe HomebusTick::Options do
  context "Methods" do
    options = HomebusTick::Options.new
    ...
    it "Uses the VERSION constant" do
      expect(options.version).to eq(HomebusTick::VERSION)
    end
...
describe TestHomebusTick do
  context "Methods" do
    options = HomebusTick::Options.new
    app = HomebusTick::App.new(options)
